...
class GiftAidCalculator
  ...
  def self.raw_gift_aid_calculation(donation_amount, event)
    return simple_gift_aid_calculation(donation_amount) unless event.promoted?
    supplemented_gift_aid_calculation(donation_amount, event)
  end
  ...
  def self.supplemented_gift_aid_calculation(donation_amount, event)
    simple_gift_aid_calculation(donation_amount) * supplement_multiplier_for(event)
  end
  ...
  def self.supplement_multiplier_for(event)
